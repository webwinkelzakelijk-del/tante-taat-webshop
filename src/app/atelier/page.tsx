      ...
      <section className="px-5 pb-16 pt-12 sm:px-8 lg:pb-24 lg:pt-20">
        <div className="mx-auto grid max-w-7xl items-end gap-10 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <div className="relative aspect-[16/11] overflow-hidden rounded-[2rem] bg-cream-deep">
            <video className="absolute inset-0 h-full w-full object-cover" controls playsInline preload="none" poster="/media/hero-poster.webp"><source src="/media/atelier-film.webm" type="video/webm" /><source src="/media/atelier-film.mp4" type="video/mp4" /></video>
          </div>
        </div>
      </section>
